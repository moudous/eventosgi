 ...
 *
 * Sem este arquivo o Laravel devolve a própria chave da regra, e o usuário vê
 * "validation.required" no lugar do aviso. As mensagens escritas direto nos controllers
 * continuam tendo precedência sobre as daqui.
 */
...
return [
    ...
    /*
     * Mensagens sob medida para um par campo/regra, quando a frase genérica não basta.
     */
    'custom' => [
        'attribute-name' => [
    ...
    /*
     * Nomes legíveis dos campos deste sistema. Sem isto o aviso sairia com o nome da
     * coluna -- "O campo evento_id é obrigatório" em vez de "O campo evento é obrigatório".
     */
    'attributes' => [
        'ativo' => 'status',
        'categoria_id' => 'categoria',
        'codigo' => 'código',
        'conteudo_html' => 'conteúdo',
        'cpf' => 'CPF',
        ...
        'limite_inscricoes' => 'quantidade de inscrições disponíveis',
        'limitar_inscricoes' => 'limitar inscrições',
        'mensagem_ja_inscrito' => 'mensagem para quem já se inscreveu',
        'mensagem_identificacao' => 'mensagem da etapa de identificação',
        'mensagem_vagas_esgotadas' => 'mensagem de vagas esgotadas',
