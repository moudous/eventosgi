...
class EventosGI_Evento {
	...
	public function renderizar( $atributos ) {
		...
		return sprintf(
			'<iframe class="eventosgi-evento" src="%1$s" title="%2$s" height="%3$d" loading="lazy" allow="camera" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation"></iframe>',
			esc_url( $origem ),
