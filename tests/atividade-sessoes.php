...
$schema->create('inscricoes_atividade', function ($table): void {
    $table->id(); $table->unsignedBigInteger('atividade_id'); $table->boolean('lista_reserva')->default(false); $table->boolean('ativa')->nullable()->default(true); $table->json('resposta'); $table->timestamps();
});
