...
<div class="row g-4 mb-4">
    <div class="col-12">
        <div class="card content-card" id="inscricoes-categoria">
            <div class="card-header"><h2 class="h5 fw-bold mb-0">Inscrições por categoria</h2></div>
...
<div class="row g-4 mb-4">
    ...
    <div class="col-12 col-lg-6">
        <div class="card content-card h-100 dashboard-card-filtro" id="evolucao-inscricoes">
            <div class="card-header"><h2 class="h5 fw-bold mb-0">Evolução do Nº de inscrições</h2></div>
            <div class="card-body p-4">
    ...
    <div class="col-12">
        <div class="card content-card h-100 dashboard-card-filtro" id="inscricoes-dispositivo">
            <div class="card-header"><h2 class="h5 fw-bold mb-0">Inscrições por dispositivo</h2></div>
            <div class="card-body p-4">
