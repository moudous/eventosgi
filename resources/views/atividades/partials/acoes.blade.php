...
@else
 ...
 @if($permissoes->permite('atividades.visualizar_formulario'))<a href="{{ route('atividades.formulario.visualizar',$atividade) }}" class="btn btn-sm btn-outline-info listagem-acao" title="Visualizar formulário"><i class="bi bi-card-text"></i></a>@endif
