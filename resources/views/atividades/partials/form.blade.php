...
function atualizarTransmissao(){if(!modalidade||!tipoLink)return;const mostrar=modalidade.value==='ead';campoLink.hidden=!mostrar;tipoLink.disabled=!mostrar;const ehIframe=tipoLink.value==='iframe';link.hidden=ehIframe;iframe.hidden=!ehIframe;link.disabled=!mostrar||ehIframe;iframe.disabled=!mostrar||!ehIframe;ajuda.textContent=ehIframe?'Cole somente um iframe com endereço HTTP ou HTTPS.':'Informe o link do vídeo. Links do YouTube mostram a miniatura no card.'}
