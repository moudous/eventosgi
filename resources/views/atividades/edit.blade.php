...
@section('content')<div class="mb-4"><h1 class="page-title">Editar atividade</h1><p class="page-description mb-0">Atualize os dados da atividade.</p></div><form method="POST" action="{{route('atividades.update',$atividade)}}" enctype="multipart/form-data">@csrf @method('PUT') @include('atividades.partials.form')</form>@endsection
