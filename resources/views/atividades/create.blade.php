...
@section('content')<div class="mb-4"><h1 class="page-title">Cadastrar atividade</h1><p class="page-description mb-0">Informe os dados da atividade.</p></div><form method="POST" action="{{route('atividades.store')}}" enctype="multipart/form-data">@csrf @include('atividades.partials.form',['atividade'=>null])</form>@endsection
