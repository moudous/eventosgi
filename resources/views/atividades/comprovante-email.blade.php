<div style="font-family:Arial,Helvetica,sans-serif;color:#22303f;line-height:1.5">
    ...
    <h3>Respostas do formulário @if($inscricao->lista_reserva)<span style="display:inline-block;margin-left:6px;padding:2px 6px;border-radius:4px;background:#fff3cd;color:#7a5700;font-size:12px">Inscrição além do limite de vagas</span>@endif</h3>
