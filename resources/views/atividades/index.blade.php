...
<table id="atividadesTable" class="table table-hover align-middle w-100 mb-0"><thead><tr><th>ID</th><th>Nome</th><th>Evento</th><th>Modalidade</th><th>Início</th><th>Fim</th><th>Status</th><th>Criado por</th><th>Criação</th><th>Alteração</th>@if($apagados)<th>Exclusão</th>@endif<th data-dt-order="disable">Ações</th></tr></thead></table>
</div></div></div>
...
const cols=[{data:'id'},{data:'nome'},{data:'evento'},{data:'modalidade'},{data:'data_inicio'},{data:'data_fim'},{data:'ativo'},{data:'criado_por'},{data:'created_at'},{data:'updated_at'},...(apagados?[{data:'deleted_at'}]:[]),{data:'acoes',orderable:false,searchable:false}];
