...
<div class="mb-4 d-flex flex-wrap justify-content-between align-items-start gap-3">
    ...
    <div class="d-flex gap-2">
        @if(app(\App\Services\GiPermissionService::class)->permite('categorias.listar'))<a href="{{ route('categorias.index') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-2"></i>Voltar</a>@endif
