...
<div class="card content-card mb-4"><div class="card-header"><h2 class="h5 fw-bold mb-0">Dados da submissão</h2></div><div class="card-body p-4"><div class="row g-4">
    ...
    <div class="col-12"><div class="alert alert-success mb-0"><h3 class="h6 fw-bold mb-1">2. Período de envio do e-pôster</h3><div class="small">Deve começar depois do fim da submissão. É neste período que o resultado será mostrado e os trabalhos aprovados poderão enviar ou substituir o PDF.</div></div></div>
    <div class="col-12 col-md-6"><label class="form-label fw-semibold" for="eposter_data_inicio">Início do envio do e-pôster *</label><input type="datetime-local" class="form-control @error('eposter_data_inicio') is-invalid @enderror" id="eposter_data_inicio" name="eposter_data_inicio" required value="{{ old('eposter_data_inicio',$submissao->eposter_data_inicio?->format('Y-m-d\TH:i')) }}">@error('eposter_data_inicio')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
    <div class="col-12 col-md-6"><label class="form-label fw-semibold" for="eposter_data_fim">Fim do envio do e-pôster *</label><input type="datetime-local" class="form-control @error('eposter_data_fim') is-invalid @enderror" id="eposter_data_fim" name="eposter_data_fim" required value="{{ old('eposter_data_fim',$submissao->eposter_data_fim?->format('Y-m-d\TH:i')) }}">@error('eposter_data_fim')<div class="invalid-feedback">{{ $message }}</div>@enderror</div>
