...
@if(!$trabalho->trashed() && $permissoes->permiteAlguma(['submissoes.inscritos.trabalhos','submissoes.avaliar','submissoes.avaliar_meus_trabalhos']))
...
@endif
@if(
    $permissoes->permiteAlguma(['submissoes.avaliar', 'submissoes.avaliar_meus_trabalhos'])
    || ($permissoes->permite('submissoes.inscritos.trabalhos') && $permissoes->permite('submissoes.inscritos.trabalhos.autores'))
)
...
@endif
@if(!$trabalho->trashed() && $permissoes->permiteAlguma(['submissoes.avaliar','submissoes.avaliar_meus_trabalhos']))
