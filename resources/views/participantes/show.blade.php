...
@section('content')<div class="mb-4 d-flex justify-content-between"><div><h1 class="page-title">Visualizar participante</h1><p class="page-description mb-0">Dados do participante no sistema de certificados.</p></div>@if(app(\App\Services\GiPermissionService::class)->permite('participantes.listar'))<a href="{{route('participantes.index')}}" class="btn btn-outline-secondary">Voltar</a>@endif</div>
